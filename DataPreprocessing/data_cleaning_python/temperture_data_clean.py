...
data_file = 'temperature.csv'  # Update with correct path if needed
...
result.columns = ['date', 'date(without year)', 'Temperature Value', 'data Completeness']
...
# Save to CSV
result.to_csv('processed_temperature_data.csv', index=False)